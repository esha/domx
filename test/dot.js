...
*/
    ...
    test('D.html', function() {
        ...
        ok(D.html instanceof Element, "D.html should be an element, not list");
    });

    test("API", function() {
        equal(typeof _.dot, "object", "_.dot");
        equal(typeof _.dot.names, "object", "_.dot.names");
        equal(typeof _.dot.fn, "function", "_.dot.fn");
    });
